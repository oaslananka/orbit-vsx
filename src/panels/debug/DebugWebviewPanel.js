...
exports.createDebugDetailWebview = createDebugDetailWebview;
const vscode = require("vscode");
const webview_1 = require("../../utils/webview");
function createDebugDetailWebview(context, sessionId) {
    const panel = vscode.window.createWebviewPanel('orbit.debug.detail', `Session - ${sessionId.slice(0, 8)}`, vscode.ViewColumn.One, {
        enableScripts: true,
...
function renderDebugDetailHtml(sessionId, _scriptUri, nonce) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
